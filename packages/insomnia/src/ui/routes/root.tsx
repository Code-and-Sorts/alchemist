        ...
        <div className="w-full h-full divide-x divide-solid divide-y divide-[--hl-md] grid-template-app-layout grid relative bg-[--color-bg]">
          <header className="[grid-area:Header] grid grid-cols-3 items-center">
            <div className="flex items-center">
              <div className="flex w-[50px] py-2">&nbsp;</div>
            </div>
                  ...
                  <NavLink
                    ...
                    to={(() => {
                      ...
                      if (!currentLocation.includes("organization")) {
                        ...
                        const prevLocationHistoryEntry = localStorage.getItem(
                          "requester_locationHistoryEntry"
                        );
          ...
          <div className="relative [grid-area:Statusbar] flex items-center justify-between overflow-hidden">
            <TooltipTrigger>
              ...
              >
                Preferences
                <Hotkey
                  keyBindings={settings.hotKeyRegistry.preferences_showGeneral}
                />
              </Tooltip>
            </TooltipTrigger>
            <Link>
              <a className="flex focus:outline-none focus:underline gap-1 items-center text-xs text-[--color-font] px-[--padding-md]">
                Privacy-focused fork of Insomnium/Insomnia{" "}
                <Icon className="text-white" icon="heart" />
              </a>
            </Link>
          </div>
        </div>
