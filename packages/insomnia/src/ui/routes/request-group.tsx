...
export const createRequestGroupAction: ActionFunction = async ({
  request,
  params,
}) => {
...
export const updateRequestGroupAction: ActionFunction = async ({
  request,
  params,
}) => {
...
export const duplicateRequestGroupAction: ActionFunction = async ({
  request,
}) => {
  ...
  if (patch.parentId) {
    ...
    models.stats.incrementCreatedRequestsForDescendants(newRequestGroup);
    return null;
  }
  const newRequestGroup = await models.requestGroup.duplicate(requestGroup, {
    name: patch.name,
...
export const updateRequestGroupMetaAction: ActionFunction = async ({
  request,
  params,
}) => {
  const { requestGroupId } = params;
